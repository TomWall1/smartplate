    ...
    <div className="min-h-screen" style={{ background: 'var(--color-parchment)' }}>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section style={cardStyle}>
          <div className="flex items-start justify-between gap-4 mb-4">
            <div>
              <h2 style={{ fontFamily: '"Fredoka One", sans-serif', color: 'var(--color-bark)', fontSize: '18px' }}>
                My Store
              </h2>
              <p className="text-sm mt-0.5" style={{ color: 'var(--color-text-muted)', fontFamily: 'Nunito, sans-serif' }}>
        ...
        {/* ── Account & Plan ───────────────────────────────────────────────── */}
        <section style={cardStyle}>
          <h2 className="mb-4" style={{ fontFamily: '"Fredoka One", sans-serif', color: 'var(--color-bark)', fontSize: '18px' }}>
            Account &amp; Plan
          </h2>
          ...
          {user ? (
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-3 flex-wrap">
                <div>
                  <p className="text-sm font-bold" style={{ color: 'var(--color-bark)', fontFamily: 'Nunito, sans-serif' }}>
                    {user.email}
                  </p>
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <button
                  ...
                  style={{ borderColor: 'var(--color-stone)', color: 'var(--color-bark)', background: '#ffffff', fontFamily: 'Nunito, sans-serif' }}
                >
            ...
            <div className="space-y-3">
              <p className="text-sm" style={{ color: 'var(--color-text-muted)', fontFamily: 'Nunito, sans-serif' }}>
                Sign in to save your store, location and household across devices — and to unlock favourites and meal planning.
              </p>
              <button
